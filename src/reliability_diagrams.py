# File: reliability_diagrams.py
# Author: Matthijs Hollemans <mail@hollance.com>
# Date: 07/14/2020
# Description: Code to plot reliability and confidence diagrams demonstrating calibration of a learning model on a dataset
# Link to original repository: <https://github.com/hollance/reliability-diagrams>
